...
export default function Header({ isDark, onToggleDark }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-50 bg-white/80 dark:bg-gray-950/80 backdrop-blur-md border-b border-beige-200 dark:border-gray-800 shadow-sm transition-colors duration-300">
