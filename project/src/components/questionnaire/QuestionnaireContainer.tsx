      ...
      <div className="flex-1 flex flex-col items-center justify-start px-4 py-10 sm:py-16">
        <div className="w-full max-w-2xl">
          <div className="text-center mb-8">
            ...
            <h1 className="text-base font-semibold text-gray-600 dark:text-gray-400 tracking-wide uppercase text-sm">
              Mon Hifz
            </h1>
          </div>
          ...
          <div className="card p-6 sm:p-10 min-h-[360px] flex flex-col">
            <div className="flex-1">{renderStep()}</div>

            <div className="flex items-center justify-between mt-8 pt-6 border-t border-beige-200 dark:border-gray-700">
              <button
                onClick={handleBack}
                disabled={currentStep === 1}
                className="btn-secondary flex items-center gap-2 px-4 py-2.5 disabled:opacity-0 disabled:pointer-events-none"
              >
