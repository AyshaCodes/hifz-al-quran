  ...
  return (
    <div className="bg-white/90 dark:bg-gray-900/90 border-b border-beige-200 dark:border-gray-800">
      <div className="max-w-5xl mx-auto text-center py-9 px-4">
        <p className="font-arabic text-2xl sm:text-3xl text-primary-700 dark:text-primary-300 mb-2">
          {surah.nameArabic}
        </p>
        <p className="text-xs sm:text-sm text-gray-700 dark:text-gray-200">{surah.nameFrench}</p>
        <p className="text-[10px] text-gray-500 dark:text-gray-400 mt-1">{surah.nameTranslit}</p>
      ...
      {shouldShowStandaloneBismillah(surahNumber) && (
        <div className="text-center py-7 px-6 bg-beige-50/80 dark:bg-gray-900/40 border-t border-beige-200/70 dark:border-gray-800">
          <p className="font-arabic text-xl sm:text-2xl text-gray-700 dark:text-gray-200 leading-[2] tracking-wide">
            {BISMILLAH_STANDALONE_ARABIC}
          </p>
